#
#   PPO Learner for GNN
#   Main changes: Unique loss for critic and actor
#
...
class PPOLearner_shared:
    def __init__(self, mac, scheme, logger, args):
        ...
        self.optimizer_params = self.agent_params + self.critic_params

        self.optimizer = Adam(params=self.optimizer_params, lr=args.lr)
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        for k in range(self.args.epochs):
            ...
            pi = mac_out
            advantages, critic_train_stats, critic_loss = self.train_critic_sequential(self.critic, self.target_critic, batch, rewards,
                                                                          critic_mask)
            ...
            # Combine losses
            combined_loss = pg_loss + self.args.critic_loss_coef * critic_loss
        ...
        if t_env - self.log_stats_t >= self.args.learner_log_interval:
            ...
            self.logger.log_stat("total_loss", combined_loss.item(), t_env)
    ...
    def train_critic_sequential(self, critic, target_critic, batch, rewards, mask):
        ...
        return masked_td_error, running_log, loss
