...
from .critic_gnn import Critic_GNN
from .critic_transformer import Critic_Transformer
REGISTRY = {}
...
REGISTRY["critic_gnn"] = Critic_GNN
REGISTRY["critic_transformer"] = Critic_Transformer